...
public class Remove extends JFrame implements ActionListener {
    ...
    Remove() {
        ...
        try {
            Connect c = new Connect();
            String query = "select * from employee_details where empId = '"+cEmpId.getSelectedItem()+"'";
            ResultSet rs = c.s.executeQuery(query);
            while(rs.next()) {
    ...
    public void actionPerformed(ActionEvent ae) {
        if (ae.getSource() == delete) {
            try {
                Connect c = new Connect();
                String query = "delete from employee_details where empId = '"+cEmpId.getSelectedItem()+"'";
